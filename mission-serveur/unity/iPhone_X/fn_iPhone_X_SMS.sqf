...
if (!(life_SMS isEqualTo [])) then {
	{
		...
		_message 					= format["<t color='#000000'>%1</t><br></br><t color='#551a8b' size='0.8' align='right'>%2</t>",_message,_datereception];
...
player setVariable ["iPhone_X_currentConversation", _phoneNumberContact];
