...
_action = [
    format [(localize "STR_GNOTF_MaxMemberMSG")+ "<br/><br/>" +(localize "STR_GNOTF_CurrentMax")+ "<br/>" +(localize "STR_GNOTF_UpgradeMax")+ "<br/>" +(localize "STR_GNOTF_Price")+ " <t color='#8cff9b'>%3 AFN</t>",_maxMembers,_slotUpgrade,[_upgradePrice] call life_fnc_numberText],
...
if (_action) then {
    if (BANK < _upgradePrice) exitWith {
        hint parseText format [
            (localize "STR_GNOTF_NotEoughMoney_2")+ "<br/><br/>" +(localize "STR_GNOTF_Current")+ " <t color='#8cff9b'>%1 AFN</t><br/>" +(localize "STR_GNOTF_Lacking")+ " <t color='#FF0000'>%2 AFN</t>",
