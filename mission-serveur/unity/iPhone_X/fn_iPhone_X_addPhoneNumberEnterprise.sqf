...
if (iPhone_X_checkPhoneNumberSubscription) exitWith {hint "Vous possédez déjà un abonnement entreprise."; iPhone_X_checkPhoneNumberSubscription = []; diag_log format ["Subscription exit primary : %1", iPhone_X_checkPhoneNumberSubscription];};
