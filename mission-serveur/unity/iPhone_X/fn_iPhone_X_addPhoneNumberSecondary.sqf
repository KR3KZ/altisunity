/*
    File: fn_iPhone_X_addPhoneNumberSecondary.sqf
    Author: Neyzhak

    Description:
    Add phone number secondary
...
if (iPhone_X_checkPhoneNumberSubscription) exitWith {hint "Vous possédez déjà un abonnement secondaire."; iPhone_X_checkPhoneNumberSubscription = []; diag_log format ["Subscription exit primary : %1", iPhone_X_checkPhoneNumberSubscription];};
...
hint format["Abonnement finalisé et opérationnel. Votre numéro secondaire est : %1", _phoneNumber];
