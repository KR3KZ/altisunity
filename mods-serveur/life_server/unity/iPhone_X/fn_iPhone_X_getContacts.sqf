/*
	File: fn_iPhone_X_getContacts.sqf
	Author: Neyzhak

	Description:
	Get all contacts for player
...
diag_log "------------- CONTACTS ------------------";
diag_log format ["Contacts for player : %1", _playerUID];
diag_log format ["Number of contacts : %1", count _result];
diag_log format ["Result : %1", _result];
diag_log "-----------------------------------------";

if (_result isEqualTo []) then
{
	_query = format ["INSERT INTO iphone_contacts (player_id, phone_number_contact, name_contact, note_contact) VALUES ('%1','50','#Depanneur','""Le Centre automobile d‘altis entretient et répare votre automobile""'),('%1','66','#Idap','""L‘O.N.G médicale à votre service""'), ('%1','61','#Polisraël','""La police de l’état indépendant d’israël""'),('%1','62','#Garde Républicaine','""La police de la nouvelle république d‘altis""'),('%1','300','*Le BarMitzvah','""Soirées privés ou professionnelles, le BarMitzvah vous accueil pour vos évènements""'), ('%1','350','*Holdi‘Sraël','""Alt‘is in the air - Diamantaire - Luxury Costumes - Mazel Car Prestige - Shalom H.L.M""'), ('%1','369','*Snack D3','""Have a break ? Have a Kebab""'),('%1','380','*Coiffeur/Barbier','""Chez Arlendo il y‘a le look qu‘il te faut""')",_playerUID];
