...
_mstatus ctrlSetStructuredText parseText format ["<img size='1.3' image='icons\ico_bank.paa'/> <t size='0.8px'>%1 AFN</t><br/><img size='1.2' image='icons\ico_money.paa'/> <t size='0.8'>%2 AFN</t>",[BANK] call life_fnc_numberText,[CASH] call life_fnc_numberText];
