...
class CfgRemoteExec {
    class Functions {
		...
		//iPhone_X
		F(UNITY_fnc_iPhone_X_addPhoneNumber,ANYONE)
		F(UNITY_fnc_iPhone_X_checkPhoneNumberIsUse,ANYONE)
		F(UNITY_fnc_iPhone_X_checkPhoneNumberSubscription,ANYONE)
		F(UNITY_fnc_iPhone_X_getContacts,ANYONE)
		F(UNITY_fnc_iPhone_X_getConversations,ANYONE)
		F(UNITY_fnc_iPhone_X_getPhoneNumber,ANYONE)
		F(UNITY_fnc_iPhone_X_getPhoneNumberActive,ANYONE)
		F(UNITY_fnc_iPhone_X_getSettings,ANYONE)
		F(UNITY_fnc_iPhone_X_getSMS,ANYONE)
		F(UNITY_fnc_iPhone_X_saveContact,ANYONE)
		F(UNITY_fnc_iPhone_X_saveConversation,ANYONE)
		F(UNITY_fnc_iPhone_X_savePhoneNumberActive,ANYONE)
		F(UNITY_fnc_iPhone_X_saveSound,ANYONE)
		F(UNITY_fnc_iPhone_X_saveWallpaper,ANYONE)
		F(UNITY_fnc_iPhone_X_sendSMS,ANYONE)
		F(UNITY_fnc_iPhone_X_saveLastSMS,ANYONE)
		F(UNITY_fnc_iPhone_X_getListNumber,ANYONE)
		F(UNITY_fnc_iPhone_X_updatePhoneNumberActive,ANYONE)
		F(UNITY_fnc_iPhone_X_getOffense,ANYONE)
		F(UNITY_fnc_iPhone_X_getSearchOffense,ANYONE)
		F(UNITY_fnc_iPhone_X_saveOffense,ANYONE)
		F(UNITY_fnc_iPhone_X_getSearchPlayer,ANYONE)
		F(UNITY_fnc_iPhone_X_getAmende,ANYONE)
		F(UNITY_fnc_iPhone_X_getValueAmende,ANYONE)
		F(UNITY_fnc_iPhone_X_getOnTheRun,ANYONE)
		F(UNITY_fnc_iPhone_X_getSearchPlayerRapport,ANYONE)
		F(UNITY_fnc_iPhone_X_saveRapport,ANYONE)
		F(UNITY_fnc_iPhone_X_getSearchRapport,ANYONE)
		F(UNITY_fnc_iPhone_X_getRapports,ANYONE)
		F(UNITY_fnc_iPhone_X_getSearchBankAccount,ANYONE)
		F(UNITY_fnc_iPhone_X_callSwitchboard,ANYONE)
		F(UNITY_fnc_iPhone_X_getSwitchboardPMC,ANYONE)
		F(UNITY_fnc_iPhone_X_setSwitchboardPMC,ANYONE)
		F(UNITY_fnc_iPhone_X_getSwitchboardIDAP,ANYONE)
		F(UNITY_fnc_iPhone_X_setSwitchboardIDAP,ANYONE)
		F(UNITY_fnc_iPhone_X_getSwitchboardCOMPANY,ANYONE)
		F(UNITY_fnc_iPhone_X_setSwitchboardCOMPANY,ANYONE)
		F(UNITY_fnc_iPhone_X_getSMSEnterprise,ANYONE)
		F(UNITY_fnc_iPhone_X_saveSilent,ANYONE)
		F(UNITY_fnc_iPhone_X_getEvents,ANYONE)
		F(UNITY_fnc_iPhone_X_saveEvent,ANYONE)
		F(UNITY_fnc_iPhone_X_removeContactFromDb,ANYONE)
